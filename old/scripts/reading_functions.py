...
if __name__ == "__main__":
    ...
    # # Old way only for 2050
    # data = {"2050": read_spores_data(paths["2050"], subfolder["2050"], files)}
    # # Simulating a smaller dataset for 2030 and 2050
    # data = generate_sim_data(data["2050"])

    data = {}
    for year in ["2030", "2050"]:
        data[year] = read_spores_data(paths[year], subfolder[year], files)
