...
def projection_to_spores_exponential(start_capacity, spores_capacity, years):
    # Get capacity values for the the range of each capacity quartile in 2030 (quartile_range_value = [min_capacity, q1_capacity, median_capacity, q3_capacity, max_capacity])
    ...
    projections = [
        {
            ...
            "y2": y_projections[4],
            "color": "red",
            "label": "Exponential growth to top 25% spores in 2030",
        },
        {
            "y1": y_projections[2],
            "y2": y_projections[3],
            "color": "orange",
            "label": "Exponential growth to second 25% spores in 2030",
        },
        {
            "y1": y_projections[1],
            "y2": y_projections[2],
            "color": "yellow",
            "label": "Exponential growth to third 25% spores in 2030",
        },
        {
            "y1": y_projections[0],
            "y2": y_projections[1],
            "color": "green",
            "label": "Exponential growth to bottom 25% capacity in 2030",
        },
    ]
...
def lock_in_projection(
    ...
    # Get capacity values for the the range of each capacity quartile in 2030
    [
        min_capacity_2030,
        q1_capacity_2030,
    ...
    # To assess the capacity that is 'locked-in' in 2050 we need to calculate the capacity that reaches end of its lifetime between 2030 and 2050.
    ...
    # FIXME: visualise declining projections from 2030 to 2050 to the 'locked-in' capacity value in 2050 that corresponds to the choice of spores in 2030
    ...
    #     year_of_retired_capacity = i+2030-technology_life
    #     if year_of_retired_capacity <= 2021:
